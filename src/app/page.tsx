          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center">
              <div className="inline-block mb-4 px-4 py-1.5 bg-white/60 backdrop-blur-md rounded-full border border-indigo-100/30">
                <span className="text-indigo-700 text-sm font-medium">✨ 在线3D模型预览平台</span>
              </div>
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed whitespace-nowrap overflow-hidden">轻松上传、预览和分享您的3D模型，支持多种格式，实时渲染，高性能显示。</p>
              ...
              <div className="grid grid-cols-3 gap-8 max-w-3xl mx-auto">
                <div className="bg-white/60 backdrop-blur-md p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-indigo-100/30">
                  ...
                  <div className="text-gray-600">模型数量</div>
                </div>
                <div className="bg-white/60 backdrop-blur-md p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-indigo-100/30">
        ...
        <section className="py-20 bg-white/40 backdrop-blur-md relative z-10">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 mt-4">为您提供专业的3D模型管理和预览解决方案</p>
            </div>
            <div className="grid md:grid-cols-3 gap-12">
              <div className="bg-white/60 backdrop-blur-md p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-indigo-100/30 hover:scale-105">
                ...
                <h3 className="text-xl font-semibold mb-4 text-center text-gray-800">实时预览</h3>
                <p className="text-gray-600 text-center">支持多种3D文件格式的在线实时预览，流畅的交互体验</p>
              </div>
              <div className="bg-white/60 backdrop-blur-md p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-indigo-100/30 hover:scale-105">
                <div className="bg-gradient-to-br from-indigo-100 to-blue-100 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <svg className="w-8 h-8 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-xl font-semibold mb-4 text-center text-gray-800">便捷上传</h3>
                <p className="text-gray-600 text-center">拖拽上传，支持批量处理，自动优化模型文件</p>
              </div>
              <div className="bg-white/60 backdrop-blur-md p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-indigo-100/30 hover:scale-105">
                <div className="bg-gradient-to-br from-indigo-100 to-blue-100 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6">
                  <svg className="w-8 h-8 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-xl font-semibold mb-4 text-center text-gray-800">模型管理</h3>
                <p className="text-gray-600 text-center">便捷的模型管理和分享功能，支持团队协作</p>
              </div>
            </div>
          </div>
        </section>
