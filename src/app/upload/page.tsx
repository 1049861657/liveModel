  ...
  return (
    <>
        ...
        {recentModels.map((model) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              {!model.isPublic && (
                <span className="w-5 h-5 flex items-center justify-center bg-gray-700 bg-opacity-90 rounded-full" title="私有">
      ...
      <ConfirmDialog
        ...
        title="警告"
        message={`确定要删除 "${modelToDelete?.name}" 吗？此操作无法撤销。`}
        confirmText="确认删除"
        type="danger"
      />
    </>
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold">上传模型</h1>
